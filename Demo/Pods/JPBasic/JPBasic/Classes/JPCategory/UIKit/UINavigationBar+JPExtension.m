...
static const char JPNavBgViewKey = '\0';
- (void)setJp_navBgView:(UIView *)jp_navBgView {
    objc_setAssociatedObject(self, &JPNavBgViewKey, jp_navBgView, OBJC_ASSOCIATION_ASSIGN);
}
- (UIView *)jp_navBgView {
    return objc_getAssociatedObject(self, &JPNavBgViewKey);
}
